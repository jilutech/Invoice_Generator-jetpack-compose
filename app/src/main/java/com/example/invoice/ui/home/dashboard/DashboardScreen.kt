...
fun DashboardData(resource: Dashboard) {
    Column(
        ...
        DashboardCard(
            icon = com.example.invoice.R.drawable.ic_invoice,
            title = stringResource(id =com.example.invoice.R.string.total_invoices),
            value = resource.invoiceCount.toString()
        )

        DashboardCard(
            icon =com.example.invoice.R.drawable.ic_money_bag,
            title = stringResource(id =com.example.invoice.R.string.received_amount),
            value = resource.receivedAmount.toString()
        )

        DashboardCard(
            icon =com.example.invoice.R.drawable.ic_money,
            title = stringResource(id =com.example.invoice.R.string.total_amount),
            value = resource.totalAmount.toString()
        )

        DashboardCard(
            icon = com.example.invoice.R.drawable.ic_invoice,
            title = stringResource(id = com.example.invoice.R.string.pending_invoices),
            value = resource.pendingInvoices.toString()
        )

        DashboardCard(
            icon = com.example.invoice.R.drawable.ic_money,
            title = stringResource(id =com.example.invoice.R.string.pending_amount),
