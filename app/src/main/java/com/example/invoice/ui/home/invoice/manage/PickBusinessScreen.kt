...
import com.example.invoice.ui.home.bussiness.BusinessCard
...
@Composable
fun PickBusiness(viewModel: InvoicesViewModel, businessModels: List<BusinessModel>, navController: NavController) {
